...
func Dump(opt *Options) gin.HandlerFunc {
	return dumpWithOptions(opt.ShowReq, opt.ShowResp, opt.ShowBody, opt.ShowHeaders, opt.ShowCookies, opt.Output)
}

func dumpWithOptions(showReq bool, showResp bool, showBody bool, showHeaders bool, showCookies bool, output io.Writer) gin.HandlerFunc {
